...
class resultController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // return redirect()->route('result')->with('success', 'Student result added successfully!');
    }
    ...
    public function update(Request $request, $id)
{
    ...
    //return redirect()->route('result')->with('success', '✅ Student Result Updated Successfully!');
}
