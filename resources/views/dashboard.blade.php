      ...
      <div class="card">
        ...
        <div class="tab-content py-0 px-0">
          ...
          <div class="d-flex flex-wrap justify-content-xl-between">
            ...
            <i class="mdi mdi-book-multiple me-3 icon-lg text-warning"></i>
            <div class="d-flex flex-column justify-content-around">
              <small class="mb-1 text-muted">Marks Management</small>
            ...
            <div
            class="d-flex py-3 d-none border-md-right flex-grow-1 align-items-center justify-content-center p-3 item">
